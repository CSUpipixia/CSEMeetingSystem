...
public class SearchMeetingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String meetingfromtime = req.getParameter("meetingfromtime");
        String meetingtotime = req.getParameter("meetingtotime");
        String page = req.getParameter("page");
        String count = req.getParameter("count");
        if (meetingfromtime == null || "".equals(meetingfromtime)) {
            meetingfromtime = "0";
        }
        if (meetingtotime == null || "".equals(meetingtotime)) {
            meetingtotime = "0";
        }
        ...
        List<Meeting> list = meetingService.searchMeeting(meetingname, roomname, reservername, reservefromdate, reservetodate, meetingfromdate, meetingtodate, Integer.parseInt(meetingfromtime),Integer.parseInt(meetingtotime), Integer.parseInt(page), Integer.parseInt(count));
